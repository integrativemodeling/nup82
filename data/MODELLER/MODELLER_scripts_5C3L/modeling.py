...
bm1.build_model(data_structure = domains, sequence_connectivity_scale=0.75, sequence_connectivity_resolution=1.0)
...
if (True):
    ...
    xl1 = IMP.pmi1.restraints.crosslinking.ISDCrossLinkMS(simo,
                                                        '../data/XL_wtNup82_DSS_standardized_no_FG_2copies.csv',
                                                        length = 21.0,
                                                        slope = 0.00,
    ...
    xl2 = IMP.pmi1.restraints.crosslinking.ISDCrossLinkMS(simo,
                                                        '../data/XL_skNup82_DSS_standardized_equiv_no_FG_2copies.csv',
                                                        length = 21.0,
                                                        slope = 0.00,
                                                        columnmapping = columnmap,
                                                        ids_map = ids_map,
    ...
    xl3 = IMP.pmi1.restraints.crosslinking.ISDCrossLinkMS(simo,
                                                        '../data/XL_wtNup82_EDC_standardized_no_FG_2copies.csv',
                                                        length = 16.0,
                                                        slope = 0.00,
                                                        columnmapping = columnmap,
                                                        ids_map = ids_map,
...
if (True):
    ...
    mc1 = IMP.pmi1.macros.ReplicaExchange0(m,
                                        ...
                                        crosslink_restraints = [xl1, xl2, xl3, xl4],
