...
import representation_GFP_nup159
...
simo = representation_GFP_nup159.Representation(m,upperharmonic=True,disorderedlength=False)
...
[("Dyn2.1",  "Dyn2.1",     0.48,   fasta_files+"Dyn2.txt",    "Dyn2",    datadirectory+"4DS1.pdb",     "A",  (  1, 92,0),    None,         beadsize,       1,      [1],        4,               None,            None, [1]),
 ...
 ("Nup159.1", "Nup159.1_99",1.0,   fasta_files+"Nup159_GFP.txt","Nup159",datadirectory+"1GFL_Nup159.pdb","A",(1461,1758,0),  None,         beadsize,       11,     [11],       4,               None,            None, [1]),
 ...
 ("Nup159.2", "Nup159.2_99",0.9,   fasta_files+"Nup159_GFP.txt","Nup159",datadirectory+"1GFL_Nup159.pdb","B",(1461,1758,0),  None,         beadsize,       12,     [12],       4,               None,            None, [1]),
...
if (True):
    ...
    if (False):
        """
        dr21 = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(1343,1343,"Nup159.1"), (1343,1343,"Nup159.2"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
        dr21.add_to_model()
        ...
        dr22 = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(541,541,"Nup82.1"), (541,541,"Nup82.2"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
        dr22.add_to_model()
        ...
        d23 = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(580,580,"Nup82.1"), (580,580,"Nup82.2"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
        d23.add_to_model()
    ...
    if (False):
        ...
        dr7 = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(649,649,"Nup82.1"), (692,692,"Nup82.2"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
        dr7.add_to_model()
        ...
        dr8 = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(649,649,"Nup82.2"), (692,692,"Nup82.1"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
        dr8.add_to_model()
        ...
        dr9 = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(541,541,"Nup82.1"), (569,569,"Nup82.2"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
        dr9.add_to_model()
        ...
        dr10 = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(541,541,"Nup82.2"), (569,569,"Nup82.1"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
        dr10.add_to_model()
